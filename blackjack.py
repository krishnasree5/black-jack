...
#only one card of the dealer is shown.All the cards player got are shown
#the player can hit or stand till the value of their cards is close to 21
#king,queen,jack have a value of 10, ace can have 1 or 11 (the player's can adjust it) and the remaining cards have the same value
